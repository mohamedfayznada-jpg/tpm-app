...
// ==========================================
// 📚 قاعدة بيانات الـ CLIT الحقيقية (177 بند مضغوطين)
// ==========================================
const rawCLITData = `منطقة الجيكات|اسفل الJIG|تنظيف|ازالة الزيوت والاتربة|هواء مضغوط+ قماش+ ماء|يومي|30s|30s|تعمل|جميع الاجزاء نظيفة|
منطقة الجيكات|فحص الBotom|تنظيف|ازالة الفوم من على البوتوم|هواء مضغوط+ قماش+ ماء|يومي|30s|30s|تعمل|جميع الاجزاء نظيفة|
منطقة الجيكات|فحص دائرة الBotom|تنظيف|التاكد من سريان المياه المراجعة على المحابس|هواء مضغوط+ قماش+ ماء|يومي|30s|30s|تعمل|جميع الاجزاء نظيفة|
منطقة الجيكات|فحص Limit switsh تهدئة ووقوف قالب الJIG اعلى واسفل|تنظيف|ازالة الزيوت والاتربة|هواء مضغوط+ قماش+ ماء|يومي|30s|30s|تعمل|جميع الاجزاء نظيفة|
منطقة الجيكات|موتور جيربوكس حركة الكابينة داخل ال JIG|تنظيف|ازالة الزيوت والاتربة|هواء مضغوط+ قماش+ ماء|يومي|30s|30s|تعمل|جميع الاجزاء نظيفة|
منطقة الجيكات|مروحة بلاورات ال JIG من الفوم + موتور البلاورات|تنظيف|ازالة الاتربة والشحومات|هواء مضغوط+ قماش+ ماء|يومي|30s|30s|تعمل|جميع الاجزاء نظيفة|
منطقة الجيكات|غطاء الفتايل|تنظيف|ازالة الاتربة والشحومات|هواء مضغوط+ قماش+ ماء|يومي|40s|40s|تعمل|جميع الاجزاء نظيفة|
منطقة الجيكات|فحص الفتايل اعلى واسفل|تنظيف|ازالة الاتربة والشحومات|هواء مضغوط+ قماش+ ماء|يومي|30s|30s|تعمل|جميع الاجزاء نظيفة|
منطقة الجيكات|جوانب جسم الـــ JIG|تنظيف|ازالة الاتربة والشحومات|هواء مضغوط+ قماش+ ماء|يومي|30s|30s|تعمل|جميع الاجزاء نظيفة|
منطقة الجيكات|سقف الــ  JIG من الخلف|تنظيف|ازالة الاتربة والشحومات|هواء مضغوط+ قماش+ ماء|يومي|30s|30s|تعمل|جميع الاجزاء نظيفة|
منطقة الجيكات|قاعدة الــ JIG من الخلف|تنظيف|ازالة الاتربة والشحومات|هواء مضغوط+ قماش+ ماء|يومي|30s|30s|تعمل|جميع الاجزاء نظيفة|
منطقة الجيكات|شفاط خلف الماكينة|تنظيف|ازالة الاتربة والشحومات|هواء مضغوط+ قماش+ ماء|يومي|30s|30s|تعمل|جميع الاجزاء نظيفة|
منطقة الجيكات|فحص موتور حركة قالب الـــــ JIG اعلى واسفل|تنظيف|ازالة الاتربة والشحومات|هواء مضغوط+ قماش+ ماء|يومي|30s|30s|تعمل|جميع الاجزاء نظيفة|
منطقة الجيكات|قواعد الــ JIG|تنظيف|ازالة الاتربة والشحومات|هواء مضغوط+ قماش+ ماء|يومي|40s|40s|تعمل|جميع الاجزاء نظيفة|
منطقة الجيكات|عمود حامل الــ JIG|تنظيف|ازالة الاتربة والشحومات|هواء مضغوط+ قماش+ ماء|يومي|30s|30s|تعمل|جميع الاجزاء نظيفة|
منطقة الجيكات|غطاء جنازير اسفل الـ JIG|تنظيف|ازالة الاتربة والشحومات|هواء مضغوط+ قماش+ ماء|يومي|40s|40s|تعمل|جميع الاجزاء نظيفة|
منطقة الجيكات||1- تحديث رقم الاصدار  2- اضافة بند الزمن الفعلى 3-- اضافة بند الحالة المثالية 4- اضافة بند حالة التدهور||||||||
المنطقة|اسم الجزء|What ماذا|Why كيف|الادوات المستخدمة|أخرى|الوقت المستغرق قبل|الوقت المستغرق بعد|حالة الماكينة|الحالة المثالية|( حالة التدهور )
منطقة الجيكات|الارضية خلف الجيك|تنظيف|ازالة الزيوت والاتربة|هواء مضغوط+ قماش+ ماء|يومي|30s|30s|تعمل|جميع الاجزاء نظيفة|
منطقة الجيكات|خراطيم مياه تسخين الجوانب|تنظيف|ازالة الاتربة|هواء مضغوط+ قماش+ ماء|يومي|30s|30s|تعمل|جميع الاجزاء نظيفة|
منطقة الجيكات|تراى خراطيم الغلاية|تنظيف|ازالة الاتربة|هواء مضغوط+ قماش+ ماء|يومي|30s|30s|تعمل|جميع الاجزاء نظيفة|
منطقة الجيكات|لوحة تشغيل الــ JIG|تنظيف|ازالة الاتربة|هواء مضغوط+ قماش+ ماء|يومي|30s|30s|تعمل|جميع الاجزاء نظيفة|
منطقة الجيكات|بكر الجيك|تنظيف|ازالة الاتربة|هواء مضغوط+ قماش+ ماء|يومي|30s|30s|تعمل|جميع الاجزاء نظيفة|
منطقة الجيكات|صندوق الفوم بالــ JIG|تنظيف|تجميع الفوم والتخلص منه|هواء مضغوط+ قماش+ ماء|يومي|30s|30s|تعمل|جميع الاجزاء نظيفة|
منطقة الجيكات|الغلاية رقم 1|تنظيف|ازالة الاتربة|هواء مضغوط+ قماش+ ماء|يومي|30s|30s|تعمل|جميع الاجزاء نظيفة|
منطقة الجيكات|الغلاية رقم 2|تنظيف|ازالة الاتربة|هواء مضغوط+ قماش+ ماء|يومي|30s|30s|تعمل|جميع الاجزاء نظيفة|
منطقة الجيكات|ماتور فرن تسخين القوالب|تنظيف|ازالة الاتربة|هواء مضغوط+ قماش+ ماء|يومي|30s|30s|تعمل|جميع الاجزاء نظيفة|
منطقة الجيكات|فرن تسخين القوالب|تنظيف|ازالة الاتربة|هواء مضغوط+ قماش+ ماء|يومي|30s|30s|تعمل|جميع الاجزاء نظيفة|
منطقة الجيكات|لوحة تشغيل الهد|تنظيف|ازالة الاتربة|هواء مضغوط+ قماش+ ماء|يومي|30s|30s|تعمل|جميع الاجزاء نظيفة|
منطقة الجيكات|لوحة تشغيل الماكينة|تنظيف|ازالة الاتربة|هواء مضغوط+ قماش+ ماء|يومي|30s|30s|تعمل|جميع الاجزاء نظيفة|
منطقة الجيكات|لوحة تشغيل الغرفة|تنظيف|ازالة الاتربة|هواء مضغوط+ قماش+ ماء|يومي|30s|30s|تعمل|جميع الاجزاء نظيفة|
منطقة الجيكات|عربات حاملة لـ القوالب|تنظيف|ازالة الاتربة|هواء مضغوط+ قماش+ ماء|يومي|30s|30s|تعمل|جميع الاجزاء نظيفة|
منطقة الجيكات|منطقة المينى بار+ الماكينة|تنظيف|ازالة الفوم والاتربة والتسريبات  الزائدة والتخلص من الفوم|هواء مضغوط+ قماش+ ماء|يومي|30s|30s|تعمل|جميع الاجزاء نظيفة|
منطقة الجيكات||1- تحديث رقم الاصدار  2- اضافة بند الزمن الفعلى 3-- اضافة بند الحالة المثالية 4- اضافة بند حالة التدهور||||||||
المنطقة|اسم الجزء|What ماذا|Why كيف|الادوات المستخدمة|أخرى|الوقت المستغرق قبل|الوقت المستغرق بعد|حالة الماكينة|الحالة المثالية|( حالة التدهور )
منطقة الجيكات|اسفل الJIG|فحص|ازالة الزيوت والاتربة|النظر واللمس|يومي|30s|30s|تعمل|جميع الاجزاء تعمل بكفاءة|
منطقة الجيكات|فحص الBotom|فحص|ازالة الفوم من على البوتوم|النظر واللمس|يومي|30s|30s|تعمل|جميع الاجزاء تعمل بكفاءة|
منطقة الجيكات|فحص دائرة الBotom|فحص|التاكد من سريان المياه المراجعة على المحابس|النظر واللمس|يومي|30s|30s|تعمل|جميع الاجزاء تعمل بكفاءة|
منطقة الجيكات|فحص Limit switsh تهدئة ووقوف قالب الJIG اعلى واسفل|فحص|ازالة الزيوت والاتربة|النظر واللمس|يومي|30s|30s|تعمل|جميع الاجزاء تعمل بكفاءة|
منطقة الجيكات|موتور جيربوكس حركة الكابينة داخل ال JIG|فحص|ازالة الزيوت والاتربة|النظر واللمس|يومي|30s|30s|تعمل|جميع الاجزاء تعمل بكفاءة|
منطقة الجيكات|مروحة بلاورات ال JIG من الفوم + موتور البلاورات|فحص|ازالة الاتربة والشحومات|النظر واللمس|يومي|30s|30s|تعمل|جميع الاجزاء تعمل بكفاءة|
منطقة الجيكات|غطاء الفتايل|فحص|ازالة الاتربة والشحومات|النظر واللمس|يومي|40s|40s|تعمل|جميع الاجزاء تعمل بكفاءة|
منطقة الجيكات|فحص الفتايل اعلى واسفل|فحص|ازالة الاتربة والشحومات|النظر واللمس|يومي|30s|30s|تعمل|جميع الاجزاء تعمل بكفاءة|
منطقة الجيكات|جوانب جسم الـــ JIG|فحص|ازالة الاتربة والشحومات|النظر واللمس|يومي|30s|30s|تعمل|جميع الاجزاء تعمل بكفاءة|
منطقة الجيكات|سقف الــ  JIG من الخلف|فحص|ازالة الاتربة والشحومات|النظر واللمس|يومي|30s|30s|تعمل|جميع الاجزاء تعمل بكفاءة|
منطقة الجيكات|قاعدة الــ JIG من الخلف|فحص|ازالة الاتربة والشحومات|النظر واللمس|يومي|30s|30s|تعمل|جميع الاجزاء تعمل بكفاءة|
منطقة الجيكات|شفاط خلف الماكينة|فحص|ازالة الاتربة والشحومات|النظر واللمس|يومي|30s|30s|تعمل|جميع الاجزاء تعمل بكفاءة|
منطقة الجيكات|فحص موتور حركة قالب الـــــ JIG اعلى واسفل|فحص|ازالة الاتربة والشحومات|النظر واللمس|يومي|30s|30s|تعمل|جميع الاجزاء تعمل بكفاءة|
منطقة الجيكات|قواعد الــ JIG|فحص|ازالة الاتربة والشحومات|النظر واللمس|يومي|40s|40s|تعمل|جميع الاجزاء تعمل بكفاءة|
منطقة الجيكات|عمود حامل الــ JIG|فحص|ازالة الاتربة والشحومات|النظر واللمس|يومي|30s|30s|تعمل|جميع الاجزاء تعمل بكفاءة|
منطقة الجيكات|غطاء جنازير اسفل الـ JIG|فحص|ازالة الاتربة والشحومات|النظر واللمس|يومي|40s|40s|تعمل|جميع الاجزاء تعمل بكفاءة|
منطقة الجيكات||1- تحديث رقم الاصدار  2- اضافة بند الزمن الفعلى 3-- اضافة بند الحالة المثالية 4- اضافة بند حالة التدهور||||||||
المنطقة|اسم الجزء|What ماذا|Why كيف|الادوات المستخدمة|أخرى|الوقت المستغرق قبل|الوقت المستغرق بعد|حالة الماكينة|الحالة المثالية|( حالة التدهور )
منطقة الجيكات|الارضية خلف الجيك|فحص|ازالة الزيوت والاتربة|النظر واللمس|يومي|30s|30s|تعمل|جميع الاجزاء تعمل بكفاءة|
منطقة الجيكات|خراطيم مياه تسخين الجوانب|فحص|ازالة الاتربة|النظر واللمس|يومي|30s|30s|تعمل|جميع الاجزاء تعمل بكفاءة|
منطقة الجيكات|تراى خراطيم الغلاية|فحص|ازالة الاتربة|النظر واللمس|يومي|30s|30s|تعمل|جميع الاجزاء تعمل بكفاءة|
منطقة الجيكات|لوحة تشغيل الــ JIG|فحص|ازالة الاتربة|النظر واللمس|يومي|30s|30s|تعمل|جميع الاجزاء تعمل بكفاءة|
منطقة الجيكات|بكر الجيك|فحص|ازالة الاتربة|النظر واللمس|يومي|30s|30s|تعمل|جميع الاجزاء تعمل بكفاءة|
منطقة الجيكات|صندوق الفوم بالــ JIG|فحص|تجميع الفوم والتخلص منه|النظر واللمس|يومي|30s|30s|تعمل|جميع الاجزاء تعمل بكفاءة|
منطقة الجيكات|الغلاية رقم 1|فحص|ازالة الاتربة|النظر واللمس|يومي|30s|30s|تعمل|جميع الاجزاء تعمل بكفاءة|
منطقة الجيكات|الغلاية رقم 2|فحص|ازالة الاتربة|النظر واللمس|يومي|30s|30s|تعمل|جميع الاجزاء تعمل بكفاءة|
منطقة الجيكات|ماتور فرن تسخين القوالب|فحص|ازالة الاتربة|النظر واللمس|يومي|30s|30s|تعمل|جميع الاجزاء تعمل بكفاءة|
منطقة الجيكات|فرن تسخين القوالب|فحص|ازالة الاتربة|النظر واللمس|يومي|30s|30s|تعمل|جميع الاجزاء تعمل بكفاءة|
منطقة الجيكات|لوحة تشغيل الهد|فحص|ازالة الاتربة|النظر واللمس|يومي|30s|30s|تعمل|جميع الاجزاء تعمل بكفاءة|
منطقة الجيكات|لوحة تشغيل الماكينة|فحص|ازالة الاتربة|النظر واللمس|يومي|30s|30s|تعمل|جميع الاجزاء تعمل بكفاءة|
منطقة الجيكات|لوحة تشغيل الغرفة|فحص|ازالة الاتربة|النظر واللمس|يومي|30s|30s|تعمل|جميع الاجزاء تعمل بكفاءة|
منطقة الجيكات|عربات حاملة لـ القوالب|فحص|ازالة الاتربة|النظر واللمس|يومي|30s|30s|تعمل|جميع الاجزاء تعمل بكفاءة|
منطقة الجيكات|منطقة المينى بار+ الماكينة|فحص|ازالة الفوم والاتربة والتسريبات  الزائدة والتخلص من الفوم|النظر واللمس|يومي|30s|30s|تعمل|جميع الاجزاء تعمل بكفاءة|
منطقة الجيكات||1- تحديث رقم الاصدار  2- اضافة بند الزمن الفعلى 3-- اضافة بند الحالة المثالية 4- اضافة بند حالة التدهور||||||||
الجيكات|ترس موتور ادخال الثلاجة|تزييت|تزييت باستخدام Mobil gear 600xp220|المزيتة اليدوى|شهري|||لاتعمل|عدد النقاط: 7|
الجيكات|جنزير تغيير عرض ال JIG|تزييت|تزييت باستخدام Mobil gear 600xp320|المزيتة اليدوى|شهري|||لاتعمل|عدد النقاط: 14|
الجيكات|جنزير فتايل صعود وهبوط ال JIG|تزييت|تزييت باستخدام Mobil gear 600xp320|المزيتة اليدوى|شهري|||لاتعمل|عدد النقاط: 7|
الجيكات|جنزير ادخال الثلاجة الى  JIG|تزييت|تزييت باستخدام Mobil gear 600xp320|المزيتة اليدوى|شهري|||لاتعمل|عدد النقاط: 14|
الجيكات|بلى فتيل صعود وهبوط ال JIG|تزييت|تزييت باستخدام Mobil gear 600xp320|المزيتة اليدوى|شهري|||تعمل|عدد النقاط: 28|
الجيكات|جسم فتايل صعود وهبوط الجيك|تشحيم|تشحيم باستخدام Mobil gear 600 XP320|المشحمة اليدوى|شهري|30|25|لاتعمل|عدد النقاط: 56|
الجيكات|فتايل ضبط عرض الجيك|تشحيم|تشحيم باستخدام Mobilux ep - 0|المشحمة اليدوى|شهري|25|6|لاتعمل|عدد النقاط: 28|
الجيكات|مسامير ثثبيت موتور حركة الــ  JIGاعلى واسفل|تربيط|تربيط مسامير ثثبيت موتور حركة الــ  JIGاعلى واسفل|مفتاح 19|شهري|60s|40s|لاتعمل|عدد النقاط: 4|
الجيكات|مسامير تثبيت غطاء موتور حركة الــ JIG اعلى واسفل|تربيط|تربيط مسامير تثبيت غطاء موتور حركة الــ JIG اعلى واسفل|الن 5|شهري|50s|30s|لاتعمل|عدد النقاط: 2|
الجيكات|مسامير تثبيت الــbottom|تربيط|تربيط مسامير تثبيت الــbottom|الن 8|شهري|50s|30s|لاتعمل|عدد النقاط: 4|
الجيكات|مسامير تثبيت البلاور فى جسم القالب|تربيط|تربيط مسامير تثبيت البلاور فى جسم القالب|الن|شهري|90s|50s|لاتعمل|عدد النقاط: 4|
الجيكات|مسامير تثبيت الفتايل|تربيط|تربيط مسامير تثبيت الفتايل|مفتاح الن 6|شهري|3m|3m|لاتعمل|عدد النقاط: 16|
الجيكات|مسامير تثبيت موتور حركة الكابينة داخل الـــ JIG|تربيط|تربيط مسامير تثبيت موتور حركة الكابينة داخل الـــ JIG|مفتاح 19|شهري|60s|50|لاتعمل|عدد النقاط: 4|
الجيكات||تربيط|تربيط |1- تحديث رقم الاصدار  2- اضافة بند الزمن الفعلى 3-- اضافة بند الحالة المثالية 4- اضافة بند حالة التدهور||توقيع مشرف القسم /|||عدد النقاط: |
منطقة الهيد|اعلى جيكات الحقن|تنظيف|ازالة الفوم والاتربة|هواء مضغوط  قماش- ماء|يومي|30|28|لاتعمل|جميع الاجزاء نظيفة|
منطقة الهيد|فحص مجموعة صمامات هيد 1|تنظيف|ازالة الفوم والزيوت|هواء مضغوط  قماش- ماء|يومي|4|2|لاتعمل|جميع الاجزاء نظيفة|
منطقة الهيد|فحص مجموعة صمامات هيد 2|تنظيف|ازالة الفوم والزيوت|هواء مضغوط  قماش- ماء|يومي|4|3|لاتعمل|جميع الاجزاء نظيفة|
منطقة الهيد|فحص مسار حركة محور Y|تنظيف|ازالة الزيوت والاتربة|هواء مضغوط  قماش- ماء|يومي|2|2|لاتعمل|جميع الاجزاء نظيفة|
منطقة الهيد|فحص دلائل حركة محور X|تنظيف|ازالة الزيوت والاتربة|هواء مضغوط  قماش- ماء|يومي|2|1|لاتعمل|جميع الاجزاء نظيفة|
منطقة الهيد|دلائل حركة هيد 1|تنظيف|ازالة الزيوت والاتربة|هواء مضغوط  قماش- ماء|يومي|2|2|لاتعمل|جميع الاجزاء نظيفة|
منطقة الهيد|دلائل حركة هيد 2|تنظيف|ازالة الزيوت والاتربة|هواء مضغوط  قماش- ماء|يومي|2|2|لاتعمل|جميع الاجزاء نظيفة|
منطقة الهيد|فحص LIMITE SWITCH|تنظيف|ازالة الزيوت والاتربة|هواء مضغوط  قماش- ماء|يومي|9|7|لاتعمل|جميع الاجزاء نظيفة|
منطقة الهيد|تراى هيد 1|تنظيف|ازالة الزيوت والاتربة|هواء مضغوط  قماش- ماء|يومي|40|30|لاتعمل|جميع الاجزاء نظيفة|
منطقة الهيد|تراى هيد 2|تنظيف|ازالة الزيوت والاتربة|هواء مضغوط  قماش- ماء|يومي|40|30|لاتعمل|جميع الاجزاء نظيفة|
منطقة الهيد|خراطيم هيد 1|تنظيف|ازالة الزيوت والاتربة|هواء مضغوط  قماش- ماء|يومي|5|2|لاتعمل|جميع الاجزاء نظيفة|
منطقة الهيد|خراطيم هيد2|تنظيف|ازالة الزيوت والاتربة|هواء مضغوط  قماش- ماء|يومي|5|2|لاتعمل|جميع الاجزاء نظيفة|
منطقة الهيد|اسفل تراى هيد 1|تنظيف|ازالة الزيوت والاتربة|هواء مضغوط  قماش- ماء|يومي|20|18|لاتعمل|جميع الاجزاء نظيفة|
عربة الهد|ترس موتور محور X|تزييت|تزييت باستخدام Mobil gear 600xp150|المزيتة اليدوى|شهري|||لاتعمل|عدد النقاط: 1|
عربة الهد|ترس موتور محور Y|تزييت|تزييت باستخدام Mobil gear 600xp220|المزيتة اليدوى|شهري|||لاتعمل|عدد النقاط: 1|
عربة الهد|ترس موتور عربة الهد|تزييت|تزييت باستخدام Mobil gear 600xp150|المزيتة اليدوى|شهري|||لاتعمل|عدد النقاط: 1|
عربة الهد|كب تزييت (Streaml Distriputer Head 1+ 2) البولو|تزييت|تزييت باستخدام Whiterx|المزيتة اليدوى|أخرى|||لاتعمل|عدد النقاط: 2|
عربة الهد|كب تزييت (Streaml Distriputer Head 1+ 2) الايزو|تزييت|تزييت باستخدام Whiterx|المزيتة اليدوى|أخرى|||لاتعمل|عدد النقاط: 2|
عربة الهيد|قضيب حركة عربة الهيد اعلى الماكينة|تشحيم|تشحيم باستخدام Mobilux ep - 0|المشحمة اليدوى|شهري|10|6|لاتعمل|عدد النقاط: 2|
عربة الهيد|الجريدة مسننة حركة عربة الهيد|تشحيم|تشحيم باستخدام Mobilux ep - 0|المشحمة اليدوى|شهري|12|3|لاتعمل|عدد النقاط: 2|
عربة الهيد|جريدة حركة عربة الهيد|تشحيم|تشحيم باستخدام Mobil gear 600 XP320|المشحمة اليدوى|شهري|3|2|لاتعمل|عدد النقاط: 2|
عربة الهيد|ترسى حركة عربة الهيد|تشحيم|تشحيم باستخدام Mobilux ep - 0|المشحمة اليدوى|شهري|6|3|لاتعمل|عدد النقاط: 2|
عربة الهيد|عجل عربة الهيد|تربيط|تربيط عجل عربة الهيد|Mobil gear 600 XP320|شهري|4|2|لاتعمل|عدد النقاط: 12|
عربة الهيد|فتايل محور X|تربيط|تربيط فتايل محور X|Mobilux ep - 0|شهري|3|1|لاتعمل|عدد النقاط: 2|
عربة الهيد||تربيط|تربيط ||||||عدد النقاط: |
المكان|اسم النقطة|تربيط|تربيط اسم النقطة|اداة التربيط|أخرى|الوقت اللازم||الوقت الفعلى|عدد النقاط: عدد النقاط|
الهيد|مسامير تثبيت افيز هيد 1 بالبالتة|تربيط|تربيط مسامير تثبيت افيز هيد 1 بالبالتة|مفتاح بلدى|شهري|3|2|لاتعمل|عدد النقاط: 4|
الهيد|مسامير تثبيت افيز هيد 2 بالبالتة|تربيط|تربيط مسامير تثبيت افيز هيد 2 بالبالتة|مفتاح بلدى|شهري|3|2|لاتعمل|عدد النقاط: 4|
الهيد|مسمار تثبيت ترس حركة عربة الهيد على الجريدة ناحية الموتور|تربيط|تربيط مسمار تثبيت ترس حركة عربة الهيد على الجريدة ناحية الموتور|طقم الن|شهري|1|1|لاتعمل|عدد النقاط: 1|
الهيد|مسمار تثبيت ترس حركة عربة الهيد المثبت على محور الموتور|تربيط|تربيط مسمار تثبيت ترس حركة عربة الهيد المثبت على محور الموتور|طقم الن|شهري|3|2|لاتعمل|عدد النقاط: 1|
الهيد|مسامير تثبيت موتور محور X|تربيط|تربيط مسامير تثبيت موتور محور X|مفتاح بلدى|شهري|3|2|لاتعمل|عدد النقاط: 3|
الفرن|رولات الفرن رقم 1|تنظيف|ازالة الاتربة|هواء قماش|يومي|5|4|لاتعمل|جميع الاجزاء نظيفة|
الفرن|رولات الفرن رقم 2|تنظيف|ازالة الاتربة|هواء قماش|يومي|2|1|لاتعمل|جميع الاجزاء نظيفة|
الفرن|موتور جيروبوكس رولات الفرن رقم 1|تنظيف|ازالة الاتربة|هواء قماش|يومي|2|1|لاتعمل|جميع الاجزاء نظيفة|
الفرن|موتور رولات الفرن رقم 2|تنظيف|ازالة الاتربة|هواء قماش|يومي|2|1|لاتعمل|جميع الاجزاء نظيفة|
الفرن|ماتور المروحة  العلوية رقم 1|تنظيف|ازالة الاتربة|هواء قماش|يومي|1|40s|لاتعمل|جميع الاجزاء نظيفة|
الفرن|ماتور المروحة العلوية رقم 2|تنظيف|ازالة الاتربة|هواء قماش|يومي|1|40s|لاتعمل|جميع الاجزاء نظيفة|
الفرن|ماتور المروحة السفلية رقم 1|تنظيف|ازالة الاتربة|هواء قماش|يومي|1|40s|لاتعمل|جميع الاجزاء نظيفة|
الفرن|ماتور المروحة السفلية رقم 2|تنظيف|ازالة الاتربة|هواء قماش|يومي|1|40s|لاتعمل|جميع الاجزاء نظيفة|
الفرن|رولات الفرن رقم 1|فحص|ازالة الاتربة|النظر والسمع|يومي|5|4|لاتعمل|جميع الاجزاء تعمل بكفاءة|
الفرن|رولات الفرن رقم 2|فحص|ازالة الاتربة|النظر والسمع|يومي|2|1|لاتعمل|جميع الاجزاء تعمل بكفاءة|
الفرن|ترس موتور رولات ادخال الثلاجة اللى الفرن رقم 1|تزييت|تزييت باستخدام Mobil gear 600xp320|المزيتة اليدوى|شهري|||لا تعمل|عدد النقاط: 1|
الفرن|ترس موتور رولات ادخال الثلاجة الى الفرن رقم 2|تزييت|تزييت باستخدام Mobil gear 600xp320|المزيتة اليدوى|شهري|||لا تعمل|عدد النقاط: 1|
الفرن|جنازير رولات الفرن رقم 1|تزييت|تزييت باستخدام Mobil gear 600xp320|المزيتة اليدوى|شهري|||لا تعمل|عدد النقاط: 6|
الفرن|جنازير رولات الفرن رقم 2|تزييت|تزييت باستخدام Mobil gear 600xp320|المزيتة اليدوى|شهري|||لا تعمل|عدد النقاط: 6|
الفرن|مسامير تثبيت موتور طلمبة البولو الخام|تربيط|تربيط مسامير تثبيت موتور طلمبة البولو الخام|مفتاح بلدى|شهري|1|1|لاتعمل|عدد النقاط: 4|
الفرن|مسامير تثبيت موتور طلمبة البولو الخام الى غرفة الخلط|تربيط|تربيط مسامير تثبيت موتور طلمبة البولو الخام الى غرفة الخلط|مفتاح بلدى|شهري|3|2|لاتعمل|عدد النقاط: 4|
الفرن|مسامير تثبيت موتور طلمبة الهيدروليك الخصة بوحدة الخلط|تربيط|تربيط مسامير تثبيت موتور طلمبة الهيدروليك الخصة بوحدة الخلط|مفتاح بلدى|شهري|2|2|لاتعمل|عدد النقاط: 4|
الفرن|مسامير تثبيت موتور طلمبة البولو + C5 الى التنكات الرئيسية لحقن الكابينة والباب|تربيط|تربيط مسامير تثبيت موتور طلمبة البولو + C5 الى التنكات الرئيسية لحقن الكابينة والباب|مفتاح بلدى|شهري|2|2|لاتعمل|عدد النقاط: 4|
مدخل الحقن|ماتور وجيريبوكس سير مدخل الفرن|تنظيف|ازالة الاتربة|قماش + هواء|أسبوعي|30s|30s|لاتعمل|جميع الاجزاء نظيفة|
مدخل الحقن|موتور رولات مدخل الفرن|تنظيف|ازالة الاتربة|قماش + هواء|أسبوعي|30s|30s|لاتعمل|جميع الاجزاء نظيفة|
مدخل الحقن|سير وبستم المدخل|تنظيف|ازالة الاتربة|قماش + هواء|أسبوعي|30s|30s|لاتعمل|جميع الاجزاء نظيفة|
مدخل الحقن|الماتور +C5 شفاط|تنظيف|ازالة الاتربة|قماش + هواء|أسبوعي|30s|30s|لاتعمل|جميع الاجزاء نظيفة|
مدخل الحقن|حامل ضبعات احتياطى|تنظيف|ازالة الاتربة|قماش + هواء|أسبوعي|30s|30s|لاتعمل|جميع الاجزاء نظيفة|
مدخل الحقن|رولات امام الفن|تنظيف|ازالة الاتربة|قماش + هواء|أسبوعي|30s|30s|لاتعمل|جميع الاجزاء نظيفة|
مخرج الحقن|رولات سير المخرج رقم 1|تنظيف|ازالة الاتربة|قماش +لصق|أسبوعي|30s|30s|لاتعمل|جميع الاجزاء نظيفة|
مخرج الحقن|رولات سير المخرج رقم 2|تنظيف|ازالة الاتربة|قماش  + لصق|أسبوعي|30s|30s|لاتعمل|جميع الاجزاء نظيفة|
مخرج الحقن|ماتور الرولات رقم 1|تنظيف|ازالة الاتربة|قماش + هواء|أسبوعي|30s|30s|لاتعمل|جميع الاجزاء نظيفة|
مخرج الحقن|لوحة تشغيل الماكينة|تنظيف|ازالة الاتربة|قماش + هواء|أسبوعي|30s|30s|لاتعمل|جميع الاجزاء نظيفة|
مدخل ومخرج الحقن|جنزير نقل الحركة  لدرافيل للفرن|تزييت|تزييت باستخدام Mobil gear 600xp320|شهرى|أخرى||||عدد النقاط: |
مدخل ومخرج الحقن|جنزير نقل الحركة  لدرافيل سير مدخل الفرن|تزييت|تزييت باستخدام Mobil gear 600xp320|شهرى|أخرى||||عدد النقاط: |
مدخل ومخرج الحقن|جنزير نقل الحركة  لدرافيل سير المخرج|تزييت|تزييت باستخدام Mobil gear 600xp320|شهرى|أخرى||||عدد النقاط: |
مدخل ومخرج الحقن|ماتور وجيريبوكس سير مدخل الفرن|تربيط|تربيط ماتور وجيريبوكس سير مدخل الفرن|مفتاح بلدى|شهري|60S|40s|لاتعمل|عدد النقاط: 4|
مدخل ومخرج الحقن|موتور رولات مدخل الفرن|تربيط|تربيط موتور رولات مدخل الفرن|مفتاح بلدى|شهري|60S|50S|لاتعمل|عدد النقاط: 4|
مدخل ومخرج الحقن|ماتور رولات المخرج|تربيط|تربيط ماتور رولات المخرج|مفتاح بلدى|شهري|60S|40s|لاتعمل|عدد النقاط: 4|
مدخل ومخرج الحقن|بالتة التجهيزة|تربيط|تربيط بالتة التجهيزة|الن|شهري|60S|40s|لاتعمل|عدد النقاط: 2|
مدخل ومخرج الحقن|بستم التجهيزة|تربيط|تربيط بستم التجهيزة|الن|شهري|60S|40s|لاتعمل|عدد النقاط: 4|
مدخل ومخرج الحقن|ماتور رولات التجهيزة|تربيط|تربيط ماتور رولات التجهيزة|مفتاح|شهري|60S|40s|لاتعمل|عدد النقاط: 2|
عربة حاملة الكابينة|موتور اخراج الكابينة من القالب فى عربة LOAD&UNLOAD|تنظيف|ازالة الاتربة|هواء مضغوط قماش|يومي|1m|40s|لاتعمل|جميع الاجزاء نظيفة|
عربة حاملة الكابينة|موتور حركة الــSIDE|تنظيف|ازالة الاتربة|هواء مضغوط|يومي|1|1|لاتعمل|جميع الاجزاء نظيفة|
عربة حاملة الكابينة|ارضية عربة الـ LOAD &UNLOAD|تنظيف|ازالة الاتربة|صابون + مياه|يومي|8m|8m|لاتعمل|جميع الاجزاء نظيفة|
عربة حاملة الكابينة|تراى العربة|تنظيف|التخلص من الفوم والاتربة|هواء مضغوط قماش-صابون|يومي|16m|15m|لاتعمل|جميع الاجزاء نظيفة|
عربة حاملة الكابينة|موتور ادخال الكابينة  الى القالب فى العربة LOAD&UNLOAD|تنظيف|ازالة الاتربة|هواء مضغوط|يومي|2|1|لاتعمل|جميع الاجزاء نظيفة|
عربة حاملة الكابينة|ريكوردر العربة|تنظيف|ازالة الاتربة|قماش + ثنر|يومي|2|1|لاتعمل|جميع الاجزاء نظيفة|
عربة حاملة الكابينة|جسم العربة|تنظيف|ازالة الاتربة|هواء مضغوط  قماش+ ماء|يومي|-|15m|لاتعمل|جميع الاجزاء نظيفة|
عربة حاملة الكابينة|زجاج العربة|تنظيف|ازالة الاتربة|هواء مضغوط  قماش+ ماء|يومي|-|6m|لاتعمل|جميع الاجزاء نظيفة|
عربة حاملة الكابينة|جريدة مسننة|تنظيف|ازالة الشحم الزائد والاتربة|هواء مضغوط  قماش+ ماء|يومي|-|4m|لاتعمل|جميع الاجزاء نظيفة|
عربة حاملة الكابينة|قضيب العربة|تنظيف|ازالة الشحم الزائد والاتربة|هواء مضغوط قماش+ ثنر|يومي|-|4m|لاتعمل|جميع الاجزاء نظيفة|
عربة حاملة الكابينة|ماتور حركة العربة|تنظيف|ازالة الاتربة|هواء مضغوط  قماش|يومي|-|80s|لاتعمل|جميع الاجزاء نظيفة|
عربة حاملة الكابينة|رولات العربة لاخراج الثلاجة|تنظيف|ازالة الاتربة|هواء مضغوط قماش+ ماء+لصق|يومي|-|5m|لاتعمل|جميع الاجزاء نظيفة|
عربة حاملة الكابينة|رولات ادخال الثلاجة الى ال JIG|تنظيف|ازالة الاتربة|هواء مضغوط قماش+ ماء+لصق|يومي|-|5|لاتعمل|جميع الاجزاء نظيفة|
تجهيزة مدخل الحقن|رولات التجهيزة|تنظيف|ازالة الاتربة|هواء مضغوط قماش|أسبوعي|30S|30S|لاتعمل|جميع الاجزاء نظيفة|
تجهيزة مدخل الحقن|بالتة صعود ونزول الثلاجة|تنظيف|ازالة الزيوت والاتربة|هواء مضغوط قماش|أسبوعي|30S|30S|لاتعمل|جميع الاجزاء نظيفة|
تجهيزة مدخل الحقن|بستم حركة السير|تنظيف|ازالة الزيوت والاتربة|هواء مضغوط قماش|أسبوعي|30S|30S|لاتعمل|جميع الاجزاء نظيفة|
تجهيزة مدخل الحقن|ارضية صندوق التجهيزة|تنظيف|تنظيف الفوم وبقايا بكر اللاصق|هواء مضغوط قماش|أسبوعي|30S|30S|لاتعمل|جميع الاجزاء نظيفة|
تجهيزة مدخل الحقن|لوحة تحكم الكهرباء|تنظيف|ازالة الاتربة|هواء مضغوط قماش|أسبوعي|30S|30S|تعمل|جميع الاجزاء نظيفة|
تنك البولو الخام|جسم وارضية التنك|تنظيف|ازالة الاتربة والتسريبات|هواء مضغوط قماش|أسبوعي|20sec|20sec|تعمل|جميع الاجزاء نظيفة|
تنك البولو الخام|طلمبة سحب البولو الخام|تنظيف|ازالة الاتربة والتسريبات|هواء مضغوط قماش|أسبوعي|30s|30s|تعمل|جميع الاجزاء نظيفة|
تنك البولو الخام|موتور القلاب|تنظيف|ازالة الاتربة والتسريبات|هواء مضغوط قماش|أسبوعي|30s|30s|تعمل|جميع الاجزاء نظيفة|
تنك الــ POLO +C5|موتور القلاب|تنظيف|ازالة الاتربة والتسريبات|هواء مضغوط قماش|أسبوعي|20sec|20sec|تعمل|جميع الاجزاء نظيفة|
تنك الــ POLO +C5|جسم وارضية التنك|تنظيف|ازالة الاتربة والتسريبات|هواء مضغوط قماش|أسبوعي|20sec|20sec|تعمل|جميع الاجزاء نظيفة|
تنك الــ POLO +C5|الجيربوكس|تنظيف|ازالة الاتربة والتسريبات|هواء مضغوط قماش|أسبوعي|20sec|20sec|تعمل|جميع الاجزاء نظيفة|
تنك الــ POLO +C5|موتور المضخة|تنظيف|ازالة الاتربة والتسريبات|هواء مضغوط قماش|أسبوعي|20sec|20sec|تعمل|جميع الاجزاء نظيفة|
تنك الــ POLO +C5|مضخة لوحدة الخلط|تنظيف|ازالة الاتربة والتسريبات|هواء مضغوط قماش|أسبوعي|30S|30S|تعمل|جميع الاجزاء نظيفة|`;

// محرك فك التشفير الذكي وتحويلها لـ JSON لحظي في المتصفح
const factoryCLITData = rawCLITData.split('\n').filter(line => line.trim() !== '').map((line, index) => {
    let p = line.split('|');
    return {
        id: 'CLIT_' + (index + 1),
        region: p[0], part: p[1], operation: p[2], action: p[3], tools: p[4],
        frequency: p[5], timeBefore: p[6], timeAfter: p[7], machineState: p[8],
