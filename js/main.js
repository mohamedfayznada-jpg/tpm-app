...
import { mountAutonomousMaintenance } from './modules/autonomous-maintenance-v2.js';
...
loadStylesheet('enterprise-v26-theme','./css/enterprise-v26.css?v=29');loadStylesheet('mobile-v27-theme','./css/mobile-v27.css?v=29');loadStylesheet('autonomous-maintenance-theme','./css/autonomous-maintenance.css?v=1');
